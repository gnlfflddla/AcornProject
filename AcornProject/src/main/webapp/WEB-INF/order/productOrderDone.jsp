...
<table width="70%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="td_default" align="center"><b>${ProductOrderDTO.userid }</b> 님의 주문이
			안전하게 처리되었습니다.</td>
	</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35"> ${ProductOrderDTO.orderName }</td>
				</tr>
				<tr>
					<td class="td_default" height="35"> 주소</td>
					<td class="td_default" height="35"> (${ProductOrderDTO.post })<br>
						${ProductOrderDTO.addr1 }&nbsp;${ProductOrderDTO.addr2 }
					</td>
				</tr>
			...
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					<td height="35" class="td_default">
						<span class="a_default">${ProductOrderDTO.pName }</span>
					</td>
					<td height="35" class="td_default" align="center">
						<span  id = "price1"><fmt:formatNumber value="${ProductOrderDTO.pPrice}" type="currency" pattern="###,###,###,###" /></span>원
					</td>
					<td height="35" class="td_default" align="center">
						<span id = "num1">${ProductOrderDTO.pAmount }</span>개
					</td>
					<td height="35" class="td_default" align="center">
						<span><fmt:formatNumber value="${ProductOrderDTO.pPrice*ProductOrderDTO.pAmount}" type="currency" pattern="###,###,###,###" /></span>원
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<input type = 'text' id = 'total' value = '<fmt:formatNumber value="${ProductOrderDTO.pPrice*ProductOrderDTO.pAmount}" type="currency" pattern="###,###,###,###" />' readonly>원
					</td>
				</tr>
				<tr>
					<td class="td_default" width="150" height="35"> 결제수단</td>
					<td class="td_default" height="35" align = 'right'> 
					<span>${ProductOrderDTO.payMethod }</span>
					</td>
				</tr>
			</table>
		</td>
