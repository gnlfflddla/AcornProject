...
<FORM name="myForm" method="GET"  action="ProductCartOrderAllDoneController">
...
<input type="hidden" name="pCode" value="${xxx.pCode}" >
<input type="hidden" name="pImage" value="${xxx.pImage}" >
<input type="hidden" name="pName" value="${xxx.pName}" >
<input type="hidden" name="pSize" value="${xxx.pSize}" >
<input type="hidden" name="pColor" value="${xxx.pColor}" >
<input type="hidden" name="pPrice" value="${xxx.pPrice}" >
<input type="hidden" name="pAmount" value="${xxx.pAmount}" >   
					<tr>
						<td class="td_default" width="80">${xxx.num}</td>
						<td class="td_default" width="80"><img
							src="/images${xxx.pImage}" border="0" align="center"
							width="80" /></td>
						<td class="td_default" width="300" style='padding-left: 30px'>
						${xxx.pName}
							<br> <font size="2" color="#665b5f">[옵션 : 사이즈(${xxx.pSize})
								, 색상(${xxx.pColor})]
						</font></td>
						<td class="td_default" align="center" width="110">
						<fmt:formatNumber value="${xxx.pPrice}" type="currency" />
						</td>
						
						<td class="td_default" align="center" width="90">${xxx.pAmount}</td>

					</tr>
                </c:forEach>
					<tr>
						<td height="30" colspan="4"></td>
						<td class="td_default" align='right'>총 결제 금액 : <fmt:formatNumber value="${totalSum}" type="currency"/> </td>
					</tr>
				</table>
		<tr>
			<td>
